...
public class Bishop extends GamePiece {
    ...
    public boolean goSouthEast(Block[][] board, int currentx, int currenty, int newx, int newy) {
        ...
        while (tempx + 1 <= newx && tempy + 1 <= newy) {
            ...
            if (tempx + 1 == newx && tempy + 1 == newy && board[tempx + 1][tempy + 1].getPiece() != null
                    && board[tempx + 1][tempy + 1].getPiece().getPlayer().getColor() != board[currentx][currenty].getPiece().getPlayer().getColor()) {
                board[newx][newy].getPiece().getPlayer().captured(board[newx][newy].getPiece());
                return true;
            }
            if (board[tempx + 1][tempy + 1].getPiece() != null) { //go one down right, if empty, move on
                return false;
            }
    ...
    public boolean goNorthWest(Block[][] board, int currentx, int currenty, int newx, int newy) {
        ...
        while (tempx - 1 >= newx && tempy - 1 >= newy) {
            ...
            if (board[tempx - 1][tempy - 1].getPiece() != null) { //go one up left, if empty move on
                return false;
            }
            if (tempx - 1 == newx && tempy - 1 == newy) {
                return true;
    ...
    public boolean goSouthWest(Block[][] board, int currentx, int currenty, int newx, int newy) {
        ...
        while (tempy + 1 <= newy && tempx - 1 >= newx) {
            ...
            if (board[tempx - 1][tempy + 1].getPiece() != null) { //go one down left
                return false;
            }
            if (tempx - 1 == newx && tempy + 1 == newy) {
                return true;
    ...
    public boolean goNorthEast(Block[][] board, int currentx, int currenty, int newx, int newy) {
        ...
        while (tempy - 1 >= newy && tempx + 1 <= newx) {
            ...
            if (board[tempx + 1][tempy - 1].getPiece() != null) { //go one up right
                return false;
            }
            if (tempx + 1 == newx && tempy - 1 == newy) {
                return true;
