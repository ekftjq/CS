...
<div id="wrapper3">
    <div id="three-column" class="container">
        ...
        <div id="tbox1"> <span class="icon icon-flag"></span>
            ...
            <a href="aboutme.php" class="button">About Me!</a> </div>
        <div id="tbox2"> <span class="icon icon-cogs"></span>
            <div class="title">
                <h2>My Projects</h2>
            </div>
            <a href="projects.php" class="button">My Projects</a> </div>
        <div id="tbox3"> <span class="icon icon-phone"></span>
            <div class="title">
                <h2>Contact Me</h2>
            </div>
            <a href="contact.php" class="button">Contact Me</a> </div>
    </div>
    </div>
