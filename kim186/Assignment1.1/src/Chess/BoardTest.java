...
public class BoardTest {
    ...
    public void testCheck() throws Exception {
        ...
        assertEquals(b.CheckChecker(b.white), true);
    }
    ...
    public void testCheckMate() throws Exception {
        ...
        assertEquals(b.CheckMate(b.white, b.CheckChecker(b.white)), false);
    ...
    public void testStaleMate() throws Exception {
        assertEquals(b.StaleMate(b.white, b.CheckChecker(b.white), b.CheckMate(b.white, b.CheckChecker(b.white))), false);
    }
}